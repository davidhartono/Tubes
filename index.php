          ...
          <div class="row min-vh-100">
            ...
            <div class="col-md-5 mt-md-0 d-lg-block d-xl-block">
              <div class="home-text py-5">
                ...
                <a href="category.html" class="btn mt-4 px-3" id="btn-catalog">Catalogue</a>
              </div>
            </div>
              ...
              <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="images/cold coffees/cold brew with vanilla sweet cream.png" class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="images/frappucino/caramel frappucino.png" class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="images/hot cofees/cappucino.png" class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="images/hot tea/My project (72).png" class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="images/iced teas/iced jeju organic green tea.png" class="d-block w-100" alt="..." />
                  </div>
                </div>
