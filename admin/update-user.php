                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="user.php" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i>&nbsp;Kembali</a>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                                ...
                                                $queryUpdate = mysqli_query($koneksi, "UPDATE akun SET email = '$email', username = '$username', password = '$password' WHERE id = $id");
                                                if ($queryUpdate) {
                                                ?>
